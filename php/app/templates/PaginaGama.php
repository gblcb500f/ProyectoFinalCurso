...
<div class="container"  >
  ...
  <?php  }else{ ?>
            <h4 class="text-danger"><?php echo $BDatos[0][8];?></h4>
            </div>
   ...
   <?php for($i=0;$i<count($BDatos);$i++){?>
         ...
         ?>
          <img class="imgMotoGama" src="/proyectoFinal/imagenes/producto/<?php echo $p; ?>" alt="">
           ...
           <p class="small">PVP : <?php echo $BDatos[$i][7];?>€</p>
            <p class="mt-2 lead font-weight-bold text-success">PVT : <?php $n=rand(100,500); $p= $BDatos[$i][7]-$n; echo $p ;?>€ </p>    
